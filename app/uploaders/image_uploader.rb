...
# Uploads to public for development and amazon s3 for production
class ImageUploader < CarrierWave::Uploader::Base
  ...
  def store_dir
    "uploads/#{model.class.to_s.underscore}/#{model.user_id}/#{model.id}"
  end
